...
in_dir <- paste0(root_dir, "/evolving_q_sim/test_run/mu_prob0.0001") # set the directory that contains the simulation results to be concatenated
outfile <- paste0(root_dir, "/evolving_q_sim/processed_results/evolved_q_mu0.0001.csv") # name the CSV output file
