...
in_dir <- paste0(root_dir, "/evolving_q_sim/raw_results/search_param_space") # set the directory that contains the simulation results to be concatenated
outfile <- paste0(root_dir, "/evolving_q_sim/processed_results/evolved_q_search_param_space.csv") # name the CSV output file
