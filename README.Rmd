...
Each of these sub-directories contains a folder `src` that contains code to run simulations and to analyze simulatio results. A folder `plots` contains figures made for the paper.